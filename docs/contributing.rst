...
services, and packages.  See :doc:`workstation_development` for more
information.

The ``good first issue`` tag is a good introduction to work available in both
the `Workstation
...
If you are a novice programmer, you can start with issues tagged `"good first
issue"
